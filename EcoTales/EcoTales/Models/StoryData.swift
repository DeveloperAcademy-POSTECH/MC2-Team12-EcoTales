...
/*
 intro1
 세상에서 가장 아름답고, 푸르른 마을에 한 아이가 살았어요.
...
/*
 intro2
 그런데, 어느 날부터 하루가 지날수록 하늘이 어두워지고 날씨가 더워지기 시작했어요.
...
/*
 intro3
 독수리는 아이가 매일 흐느끼며 우는 모습을 보니 마음이 너무 아팠어요.
 '이 문제를 해결할 수 있는 방법은 없을까?' 고민하던 독수리는 하늘을 날아다니며 지혜로운 자를 찾아다녔어요.

 독수리가 답을 찾았는지, 다시 아이에게 왔네요.
 "아이야, 레서판다 미뉴가 답을 알고 있대! 판다 씨에게 몇 가지 재료만 가지고 가면, 병들어 있는 세계수를 치료할 치료약을 만들어 주신다고 하셨어."
